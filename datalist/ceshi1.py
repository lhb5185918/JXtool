...
from common import chinese_to_initials, CommonDatabase, strip_control
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(310, 70, 332, 161))
        ...
        self.host_2.setText(CommonDatabase().config()['host'])
        ...
        self.databasename.setText(CommonDatabase().config()['db'])
        ...
        self.username.setText(CommonDatabase().config()['user'])
        ...
        self.password.setText(CommonDatabase().config()['password'])
    ...
    def get_database(self):
        CommonDatabase().config("host", self.host_2.text())
        CommonDatabase().config("port", self.port.text())
        CommonDatabase().config("user", self.username.text())
        CommonDatabase().config("password", self.password.text())
        CommonDatabase().config("database", self.databasename.text())
        return CommonDatabase().config("database")
